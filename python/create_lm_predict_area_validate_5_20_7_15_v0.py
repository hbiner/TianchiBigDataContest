...
##  create lm_predict_area_validate_5_20_7_15_v0 
#connect all
sql("""
drop table if  exists lm_predict_area_validate_5_20_7_15_v0  ;
create table lm_predict_area_validate_5_20_7_15_v0 as
select 
