#
sql("""
create table lmn_train_area_validate_4_11_7_15_lab01_union_x
as select
	a.user_id,
     a.brand_id,
	click1	 ,
...
from lmn_train_area_validate_4_11_7_15_lab01_union_u_b  a

left outer join 
lmn_ub_df_4_11_6_15 d
...
###
sql("""
create table lmn_predict_area_validate_5_11_7_15_x
as select
	a.user_id,
     a.brand_id,
	click1	 ,
...
from  lmn_predict_area_validate_5_11_7_15_u_b  a
